...
public class IndicadoresIIBIOClient {

    private final Client client;
    private final JerseyClientBuilder clientBuilder;
    private final URI root;

    public IndicadoresIIBIOClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public IndicadoresIIBIOClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
    ...
    private static Client buildClient(JerseyClientBuilder clientBuilder) {
        ...
        return builder
            ...
            .using(jerseyConfig).build("indicadoresIIBIOClient");
    }
}
